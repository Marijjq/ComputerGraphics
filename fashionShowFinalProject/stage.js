...
export function loadStage(scene, textures, renderer, camera) {
  ...
  const animationQueue = [
    { path: '3Dmodels/model1.glb', position: [50, 10, -50], scale: [28, 28, 28], rotation: 0, key: 'model1' },
    ...
    { path: '3Dmodels/model4.glb', position: [50, 10, -50], scale: [32, 32, 32], rotation: 0, key: 'model4' },
  ];
  ...
  audioLoader.load('audio/applause-sound-effect-240470.mp3', function(buffer) {
